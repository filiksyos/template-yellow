...
export default {
  ...
  theme: {
    extend: {
      colors: {
        primary: {
          DEFAULT: '#FBBF24', // Amber-400: Golden yellow
          light: '#FCD34D',   // Amber-300: Soft yellow
          dark: '#F59E0B',    // Amber-500: Deep golden
        },
        danger: {
      ...
      boxShadow: {
        ...
        'hover': '0 4px 6px -1px rgba(251, 191, 36, 0.1), 0 2px 4px -1px rgba(251, 191, 36, 0.06)',
      }
    },
  },
  plugins: [],
